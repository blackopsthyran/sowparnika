...
const CreateListingPage = () => {
  ...
  const handleInputChange = (
    ...
    // If property type changes, set areaUnit to 'Cent' for land/plot/commercial building types
                    ...
                    <FormControl isRequired gridColumn={{ base: '1', md: '1 / -1' }}>
                      ...
                      >
                        <ReactQuill
                          ...
                          placeholder="Describe your property in detail... Click 'Enhance with AI' to improve your text"
                        />
                      </Box>
